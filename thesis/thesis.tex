...
The problem we will be looking at here, is a unique situation where the problem consist 
purely of binary data-points. Since we will be comparing binary vectors, we can look at them as
sequences and calculate the distance between two data-points by using hamming distance. Thereby 
defining the distance metrics as how many differentiating bits are between two vectors.
