...
\frefformat{vario}{\fancyrefalglabelprefix}{\textbf{algorithm\fancyrefdefaultspacing#1}}
\Frefformat{vario}{\fancyrefalglabelprefix}{\textbf{Algorithm\fancyrefdefaultspacing#1}}

\newcommand*{\fancyrefproblabelprefix}{prob}
\frefformat{vario}{\fancyrefproblabelprefix}{\textbf{problem\fancyrefdefaultspacing#1}}
\Frefformat{vario}{\fancyrefproblabelprefix}{\textbf{Problem\fancyrefdefaultspacing#1}}

\newcommand*{\fancyreflemlabelprefix}{lem}
\frefformat{vario}{\fancyreflemlabelprefix}{\textbf{lemma\fancyrefdefaultspacing#1}}
\Frefformat{vario}{\fancyreflemlabelprefix}{\textbf{Lemma\fancyrefdefaultspacing#1}}

\newcommand*{\fancyrefdeflabelprefix}{def}
\frefformat{vario}{\fancyrefdeflabelprefix}{\textbf{definition\fancyrefdefaultspacing#1}}
\Frefformat{vario}{\fancyrefdeflabelprefix}{\textbf{Definition\fancyrefdefaultspacing#1}}
